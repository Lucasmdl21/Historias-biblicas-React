const moises = {
  ...
  texto: [
    ...
    "Deus ouviu o clamor do seu povo. Naquele tempo, nasceu um bebê chamado Moisés 👶. O faraó havia ordenado que todos os meninos hebreus fossem mortos, pois tinha medo do povo crescer.",

    "Para salvar seu filho, a mãe de Moisés colocou-o em um cesto e o deixou flutuando no rio Nilo 🌊, confiando que Deus cuidaria dele.",

    "A filha do faraó encontrou o bebê no rio e ficou com muita compaixão 💖. Ela decidiu criá-lo como seu próprio filho e deu a ele o nome de Moisés.",

    "Moisés cresceu no palácio, aprendendo muitas coisas, mas em seu coração nunca esqueceu que fazia parte do povo de Deus.",

    "Quando já era adulto, Moisés precisou fugir do Egito e foi morar no deserto 🐑, onde se tornou pastor de ovelhas.",

    "Certo dia, Deus falou com Moisés através de uma sarça ardente 🔥 que queimava, mas não se consumia. Deus o chamou para uma grande missão.",

    "Deus disse a Moisés que ele deveria voltar ao Egito e libertar o povo de Israel da escravidão. Moisés teve medo, mas Deus prometeu estar com ele 🙏.",
    ...
    "Quando chegaram ao Mar Vermelho, Deus realizou um grande milagre 🌊✨. O mar se abriu, e o povo passou em segurança pelo meio dele.",
